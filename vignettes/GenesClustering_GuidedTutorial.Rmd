...
plot(heatmapPlot(obj, genesLists = genesLists, sets = 1L:3L))
```
...
```{r Heatmap plot of coex given primary marker genes}
# take the first marker per layer
layersMarkers <- lapply(layersGenes, \(gl){gl[[1L]]})
invisible(
  genesHeatmapPlot(
    obj,
