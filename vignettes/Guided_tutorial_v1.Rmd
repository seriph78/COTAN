...
getGEOSuppFiles("GSM2861514", makeDirectory = TRUE, baseDir = dataDir,
  fetch_files = TRUE, filter_regex = "GSM2861514_E175_Only_Cortical_Cells_DGE.txt.gz")
...
GDIPlot(obj, cond = t, genes = genesList)
```
...
```{r}
heatmapPlot(genesLists = genesList, sets = c(1:3), conditions = t, dir = outDir)
```
