...
This tutorial contains the same functionalities as the first release of COTAN tutorial but done using the new and updated functions.
...
The next function can either plot the GDI for the dataset directly or use the precomputed dataframe. It marks a 1.5 threshold (in red) and the two highest quantiles (in blue) by default. We can also specify some gene sets (three in this case) that we want to label explicitly in the GDI plot.
