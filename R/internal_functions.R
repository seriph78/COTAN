...
setMethod(
  ...
  function(object) {
    ...
    output <- list(
      "dist_cells" = dist_cells, "to_clust" = to_clust, "pca_cells" = pca_cells,
...
setMethod(
  ...
  function(object) {
    ...
    print(paste("The distance between estimated n of zeros and observed number of zero is",
      dist_zeros, "over", length(rownames(M)),
      sep = " "
    ))
    ...
    out <- list(
      "estimator_no_no" = estimator_no_no, "estimator_no_yes" = estimator_no_si,
